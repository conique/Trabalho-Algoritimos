            ...
            case '1':
                ...
                case '2': //FORMOSA PARA CRIXÁS
                    ...
                    case '1':
                        ...
                        while (numcadfc > numcadFC3 || numcadfc < 0) {
                    ...
                    case '2':
                        ...
                        printf("Digite quantas cadeiras deseja comprar:");
                        scanf("%d", & numcadfc);
                        while (numcadfc > numcadFC6 || numcadfc < 0) {
                            printf("Por favor digite um valor válido\n");
                            scanf("%d", & numcadfc);
                        }
                        printf("Passagem comprada com sucesso!\n");
                    ...
                    case '3':
                        ...
                        printf("Digite quantas cadeiras deseja comprar:");
                        scanf("%d", & numcadfc);
                        while (numcadfc > numcadFC9 || numcadfc < 0) {
                            printf("Por favor digite um valor válido\n");
                            scanf("%d", & numcadfc);
                        }
                        printf("Passagem comprada com sucesso!\n");
                ...
                case '3': //FORMOSA PARA METROPOLIS
                    ...
                    case '1':
                        ...
                        printf("Digite quantas cadeiras deseja comprar:");
                        scanf("%d", & numcadfm);
                        while (numcadfm > numcadFM3 || numcadfm < 0) {
                            printf("Por favor digite um valor válido\n");
                            scanf("%d", & numcadfm);
                        }
                    ...
                    case '2':
                        ...
                        printf("Digite quantas cadeiras deseja comprar:");
                        scanf("%d", & numcadfm);
                        while (numcadfm > numcadFM6 || numcadfm < 0) {
                            printf("Por favor digite um valor válido\n");
                            scanf("%d", & numcadfm);
                        }
